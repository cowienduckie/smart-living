...
namespace SmartLiving.Data.Migrations
{
    ...
    [Migration("20220721064832_Update-CreateDevice-Flow")]
    partial class UpdateCreateDeviceFlow
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartLiving.Domain.Entities.Role", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("SmartLiving.Domain.Entities.UserRole", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("SmartLiving.Domain.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SmartLiving.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasOne("SmartLiving.Domain.Entities.Role", "Role")
                        .WithMany("UserRoles")
